...
`select` is a helper function created by Luara for reading data from our database. It takes two arguments: an SQL query string and optional extra dynamic parameters. You do not need the parameters yet.
...
- In `badge` table, look at which badges already exist in the database.
